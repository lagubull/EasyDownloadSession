...
class DownloadTaskInfoTest: XCTestCase {
    ...
    func test_didUpdateProgress_progessShouldBeInvoked () {
        ...
        insertedTask = DownloadTaskInfo.init(downloadId: self.insertedTaskId!,
                                             URL: NSURL.init(string: "URL")!,
                                             session: self.session!,
                                             stackIdentifier: "SessionIdentifier",
        ...
        progressExpectation = self.expectationWithDescription("Progress expectation")
    ...
    func test_didSucceedWithLocation_successLocationIsUsed() {
        ...
        insertedTask = DownloadTaskInfo.init(downloadId: self.insertedTaskId!,
                                             ...
                                             success: { [unowned self] (downloadTask: DownloadTaskInfo!, responseData: NSData?) in
                                                ...
                                                let resultString =  String.init(data: responseData, encoding: NSUTF8StringEncoding)
        ...
        insertedTask!.didSucceedWithLocation(NSURL.init(string: locationString)!)
        
        successExpectation = self.expectationWithDescription("Location is not used")
    ...
    func test_didSucceedWithLocation_didFailWithErrorIsInvoked() {
        ...
        let task =  DownloadTaskInfoMock.init(downloadId: self.insertedTaskId!,
                                             URL: NSURL.init(string: "URL")!,
                                             session: self.session!,
                                             stackIdentifier: "SessionIdentifier",
                                             progress: nil,
        ...
        task.didSucceedWithLocation(NSURL.init(string: "URL")!)
